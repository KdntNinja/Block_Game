...
from KdnTools import DriveLetter
...
LOCATION = f"{DriveLetter}:/Code/Python/Block_Game/"
...
def save_app():
    ...
    with open(f"{LOCATION}data/save_app.pkl", "wb") as f:
...
def load_app():
    try:
        with open(f"{LOCATION}data/save_app.pkl", "rb") as f:
